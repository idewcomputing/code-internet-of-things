...
**TASK:** Review the information below to begin to understand how to use the parts in your Photon kit to create electric circuits, and answer the questions in this document.
{% endhint %}
...
All of this information about using the jumper wires and breadboard to connect inputs and outputs to the circuit board will really only make sense once you have hands-on experience building some practice devices. Tutorials 2-4 are designed to give you that experience.
