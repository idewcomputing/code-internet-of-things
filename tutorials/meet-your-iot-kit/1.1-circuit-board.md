...
As this occurs, the RGB light will change its color and blinking pattern to indicate the current status of the Photon device. The RGB light will either "blink" \(fast blinking\) or "breathe" \(slow blinking\).
