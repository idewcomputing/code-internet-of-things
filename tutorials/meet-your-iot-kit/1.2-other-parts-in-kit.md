...
{% hint style="info" %}
SparkFun sells a [USB to Barrel Jack Adapter cable](https://www.sparkfun.com/products/8639) which is a great alternative to the two included power cables. This cable connects to a USB port \(computer, charger, etc.\) and plugs into the Photon's barrel jack, which is much sturdier and easier to use \(compared to the Micro-USB port\). This cable will supply ~5 volts to the Photon's VIN power pin.
{% endhint %}
