...
If you want an **OPTIONAL** challenge, connect a 2nd LED and 2nd button to your Photon device \(use a different color than your 1st LED and 1st button\). Then modify your Photon device app and your web app, so that each LED can be monitored and controlled separately.
