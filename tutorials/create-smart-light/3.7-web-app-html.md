...
Line 7 of the HTML has a `<link>` tag to load a CSS stylesheet file. The CSS stylesheet will be used to modify the appearance of certain HTML elements in your web app.
...
Lines 11-15 of the HTML contains a `<div>` section that will become a "card" displaying information about your Smart Light. This card will display:
