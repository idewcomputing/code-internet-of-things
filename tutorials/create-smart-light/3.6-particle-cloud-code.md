...
2. The web app will have a button that you can click to remotely turn the LED light on or off. The web app will do this by calling the `toggleLight()` function in your Photon device app.
