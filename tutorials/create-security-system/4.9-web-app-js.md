...
This JS adds a custom function named `checkMode()` that contains a call to the `particle.getVariable()` method that will get the current value of the `"deviceMode"` variable in your Photon app.
