...
Your CSS has style declarations for several elements in your HTML:
...
3. The CSS for `#motion-alert` styles elements in your HTML that have `id="motion-alert"`. The second `<div>` has this class.
