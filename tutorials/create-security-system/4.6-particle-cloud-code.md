...
By default, Particle Cloud will clear each cloud event after 60 seconds to prevent your web app from receiving duplicate notifications or outdated notifications.
